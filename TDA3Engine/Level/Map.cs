...
namespace TDA3Engine
{
    ...
    public class Map
    {
        ...
        public int Money
        {
            ...
            {
                money = value;
                MoneyInfo = String.Format("Dinero: {0}", money);
            }
        }
        ...
        public class MapReader : ContentTypeReader<Map>
        {
            protected override Map Read(ContentReader input, Map existingInstance)
            {
                ...
                map.TowersInfo = String.Format("Torres disponibles: {0}", map.TowersAvailable.Count);
                ...
                map.WavesInfo = String.Format("Olas: {0}", map.WavesAvailable.Count);
