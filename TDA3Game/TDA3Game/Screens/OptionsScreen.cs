    ...
    public class OptionsScreen : GameScreen
    {
        ...
        void music_LeftClickEvent(object sender, EventArgs e)
        {
            if (OptionsState == TDA3Game.OptionsState.Normal)
            {
                ...
                OptionsState = TDA3Game.OptionsState.Music;
            }
            else if (OptionsState == TDA3Game.OptionsState.Music)
            {
                Button b = sender as Button;
                b.Texture = inactiveButtonTexture;
                Vector2 pos = new Vector2((int)(musicBlock.Dimensions.Left + b.Texture.Width), (int)(musicBlock.Dimensions.Top + b.Texture.Height));
        ...
        {
            if (OptionsState == TDA3Game.OptionsState.Normal || OptionsState == TDA3Game.OptionsState.Music) musicBlock.Draw(gameTime, ScreenSystem.SpriteBatch, font);
            if (OptionsState == TDA3Game.OptionsState.Normal || OptionsState == TDA3Game.OptionsState.Sound) soundBlock.Draw(gameTime, ScreenSystem.SpriteBatch, font);
        ...
        protected override void UpdateScreen(GameTime gameTime)
        {
            ...
            if (OptionsState == TDA3Game.OptionsState.Music)
            {
